      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Reduce waste. Eat better. Live healthier.
            </p>
          </div>
        </div>
        ...
        <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <p className="text-gray-600">
              {isLogin 
                ? 'Sign in to your NourishCare account' 
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 bg-green-600 hover:bg-green-700 transition-all duration-200"
              >
        ...
        <div className="text-center space-y-4">
          <div className="grid grid-cols-3 gap-4 text-xs text-gray-600">
            <div className="space-y-2">
              <div className="bg-green-100 p-2 rounded-full w-8 h-8 mx-auto flex items-center justify-center">
